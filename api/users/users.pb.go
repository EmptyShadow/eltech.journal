...
type CreateRequest struct {
	...
	SHA1HashPWD string           `protobuf:"bytes,3,opt,name=SHA1HashPWD,proto3" json:"SHA1HashPWD,omitempty"`
}
...
func (m *CreateRequest) GetSHA1HashPWD() string {
	if m != nil {
...
var fileDescriptor_030765f334c86cea = []byte{
	...
	0xf6, 0x70, 0x34, 0xf4, 0x48, 0x2c, 0xce, 0x08, 0x08, 0x77, 0x91, 0x60, 0x06, 0x5b, 0x86, 0x2c,
	0xa4, 0x14, 0xca, 0xc5, 0x07, 0x73, 0x59, 0x71, 0x41, 0x7e, 0x5e, 0x71, 0xaa, 0x90, 0x33, 0x17,
	0x4b, 0x68, 0x71, 0x6a, 0x11, 0xd8, 0x65, 0xdc, 0x46, 0xfa, 0x24, 0x38, 0x00, 0xa4, 0x2d, 0x08,
	0xac, 0xd9, 0xa8, 0x83, 0x91, 0x8b, 0x15, 0xc4, 0x28, 0x16, 0xaa, 0xe7, 0x62, 0x83, 0x58, 0x20,
	0x64, 0x41, 0x82, 0x51, 0x28, 0xa1, 0x25, 0x65, 0x49, 0x86, 0x4e, 0x88, 0x6f, 0x94, 0x18, 0x9c,
	0x52, 0x2f, 0x3c, 0x94, 0x63, 0xb8, 0xf1, 0x50, 0x8e, 0xe1, 0xc3, 0x43, 0x39, 0xc6, 0x86, 0x47,
	...
	0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x44, 0xe9, 0x13, 0x1f, 0xd5, 0xe0, 0xc4, 0x94,
	0xc4, 0x06, 0x8e, 0x6a, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4b, 0xc9, 0x14, 0xf8, 0x5c,
	0x02, 0x00, 0x00,
}
...
func (this *CreateRequest) Equal(that interface{}) bool {
	...
	if this.SHA1HashPWD != that1.SHA1HashPWD {
		return false
	}
	return true
}
...
func (m *CreateRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.SHA1HashPWD = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
